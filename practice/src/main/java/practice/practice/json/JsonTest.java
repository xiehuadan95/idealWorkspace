...
public class JsonTest {
    ...
    public void testIdNum(){
        ...
        //获取内层内容
        String res = ((JSONObject) messagebody.get("args")).getString("print_scene");
        System.out.println("获取内部嵌套内容为："+res);
        //如果是空串
        String res2 = ((JSONObject) messagebody.get("args")).getString("query_type");
        System.out.println("获取内部嵌套内容2为："+res2);
